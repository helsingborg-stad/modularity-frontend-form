...
it('generates a valid query selector from validity keys', () => {
    ...
    it('caches and reuses validation message from dataset', () => {
        ...
        const instance = new CustomInvalidValidationMessageItem(input, ['valueMissing'], 'jsValidationMessage');
    ...
    it('uses default validation message if no custom message is provided', () => {
        ...
        new CustomInvalidValidationMessageItem(input, validationKeys, 'jsValidationMessage');
    ...
    it('does nothing when input is valid', () => {
        ...
        const input = document.querySelector('input')!;
        new CustomInvalidValidationMessageItem(input, ['valueMissing'], 'jsValidationMessage');
    ...
    it('allows for custom validation message using: %s', async () => {
        ...
        const input = document.querySelector('input')!;
        const instance = new CustomInvalidValidationMessageItem(input, ['valueMissing', 'typeMismatch', 'patternMismatch'], 'jsValidationMessage');
