class WysiwygConditionsHandler implements ConditionsHandlerInterface {
    ...
    public init(parent: WysiwygInterface, conditionsBuilder: ConditionBuilderInterface): void {
        this.parent = parent;
...
export default WysiwygConditionsHandler;