...
if (function_exists('acf_add_local_field_group')) {
    ...
    'fields' => array(
        ...
        4 => array(
            ...
            'label' => __('In Progress Post Status', 'modularity-frontend-form'),
        ...
        5 => array(
            ...
            'label' => __('Reviewed Post Status', 'modularity-frontend-form'),
            'name' => 'reviewedPostTypeStatus',
            'aria-label' => '',
            'type' => 'select',
            'instructions' => __('The post status to use when a form have been reviewed by the user.', 'modularity-frontend-form'),
            'required' => 1,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '50',
