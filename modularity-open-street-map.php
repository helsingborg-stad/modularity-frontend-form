...
define('MODULARITYFRONTENDACFFORM_TEMPLATE_PATH', MODULARITYFRONTENDACFFORM_PATH . 'templates/');
define('MODULARITYFRONTENDACFFORM_VIEW_PATH', MODULARITYFRONTENDACFFORM_PATH . 'views/');
